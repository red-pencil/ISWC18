...
public class TxEyesOutput {
	[SerializeField]
	CameraConfigurations _configuration;
	...
	public delegate void OnImageArrived_deleg(TxEyesOutput src,int eye);
	public OnImageArrived_deleg OnImageArrived;

	public delegate void Deleg_OnEyesOutputChanged(TxEyesOutput output);
