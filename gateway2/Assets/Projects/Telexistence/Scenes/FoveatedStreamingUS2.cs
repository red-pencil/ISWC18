	...
	void Update () {
		...
		case EStatus.EReading:
            ...
            if (UserStudy)
            {
                ...
                _dbHeadWriter.AddData("Rx", Body.HeadOrientation.eulerAngles.x.ToString());
                _dbHeadWriter.AddData("Ry", Body.HeadOrientation.eulerAngles.y.ToString());
                _dbHeadWriter.AddData("Rz", Body.HeadOrientation.eulerAngles.z.ToString());
