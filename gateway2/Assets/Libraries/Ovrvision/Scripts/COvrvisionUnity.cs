...
public class COvrvisionUnity
{
    ...
    [DllImport(DLL_Name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    static extern int ovOpen(System.IntPtr inst, int locationID, int type);
    [DllImport(DLL_Name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    ...
    public enum OVRResolution {
     OV_CAM5MP_FULL = 0,	//2560x1920 @15fps x2
     OV_CAM5MP_FHD = 1,		//1920x1080 @30fps x2
     OV_CAMHD_FULL = 2,		//1280x960  @45fps x2
     OV_CAMVR_FULL = 3, 	//960x950   @60fps x2
     OV_CAMVR_WIDE = 4,		//1280x800  @60fps x2
     OV_CAMVR_VGA = 5,		//640x480   @90fps x2
     OV_CAMVR_QVGA = 6     //320x240   @120fps x2
    }
    ...
    public delegate void OnImageUpdateDeleg(COvrvisionUnity self);
    public event OnImageUpdateDeleg OnImageUpdate;
    ...
    public bool Open(int opentype)
    {
        ...
        //Open camera
		if (ovOpen(_instance,0, opentype) == 0)
        {
    ...
    public bool UpdateImage(System.IntPtr leftPtr, System.IntPtr rightPtr)
    {
        ...
        BlitCameraImage(leftPtr, rightPtr);
		return true;
	}
	...
	//For get pixel
	public void GetImagePixelColor(System.IntPtr ptr, int eye)
    {
		ovGetCamImageBGRA(_instance, ptr, eye);
	}
    ...
    */
    ...
    private float GetImageBaseHeight(int opentype)
	{
		float res = 960.0f;
		switch(opentype) {
			case (int)OVRResolution.OV_CAM5MP_FULL: res = 1920.0f;
				break;
			case (int)OVRResolution.OV_CAM5MP_FHD: res = 1920.0f;
				break;
			case (int)OVRResolution.OV_CAMHD_FULL: res = 960.0f;
				break;
			case (int)OVRResolution.OV_CAMVR_FULL: res = 960.0f;
				break;
			case (int)OVRResolution.OV_CAMVR_WIDE: res = 960.0f;
				break;
			case (int)OVRResolution.OV_CAMVR_VGA: res = 480.0f;
				break;
			case (int)OVRResolution.OV_CAMVR_QVGA: res = 240.0f;
				break;
			default : break;
		}
